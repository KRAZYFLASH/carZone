...
-- 2) Bersihkan data (dua tabel sekaligus biar aman terhadap FK)
TRUNCATE TABLE car, engine;

-- 3) Tambah FK sesudah truncate
ALTER TABLE IF EXISTS car DROP CONSTRAINT IF EXISTS fk_engine_id;
ALTER TABLE car
